    <header class="bg-white px-6 shadow dark:bg-slate-900">
      ...
      >
        <a class="block rounded-md px-3 py-2 {{ request()->routeIs('dashboard') ? 'bg-sky-500 text-white' : 'text-slate-700 transition-colors hover:bg-sky-500 hover:text-white dark:text-slate-400 dark:hover:text-white' }}"
